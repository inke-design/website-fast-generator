...
const html = `<section>
        ...
        <div class="container">
          <header class="row">
            ...
            <div class="accounts col-sm-6 col-6 pr-0">
              <li class="top_li1"><a href="http://demo2.cssmoban.com/cssthemes6/gfgbdsfsddbs/index.html#">Login</a></li>
              <li class="top_li2"><a href="http://demo2.cssmoban.com/cssthemes6/gfgbdsfsddbs/index.html#">Register</a>
              </li>
            </div>
    ...
    <section class="w3l-bootstrap-header">
      <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
        <div class="container">
          <a class="navbar-brand" href="http://demo2.cssmoban.com/cssthemes6/gfgbdsfsddbs/index.html"><span>D-</span>Business</a>
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
              <li class="nav-item">
                <a class="nav-link" href="http://demo2.cssmoban.com/cssthemes6/gfgbdsfsddbs/index.html">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="http://demo2.cssmoban.com/cssthemes6/gfgbdsfsddbs/about.html">About</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="http://demo2.cssmoban.com/cssthemes6/gfgbdsfsddbs/services.html">Services</a>
              </li>


              <li class="nav-item">
                <a class="nav-link" href="http://demo2.cssmoban.com/cssthemes6/gfgbdsfsddbs/contact.html">Contact</a>
              </li>
            </ul>
            <p>For Support Call<span class="fa fa-headphones pl-1"></span><br><a href="tel:XXX">XXX</a></p>
          </div>
        </div>
      </nav>
    </section>
