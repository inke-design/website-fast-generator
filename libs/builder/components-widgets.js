...
*/
Vvveb.ComponentsGroup['Widgets'] = ["widgets/googlemaps", "widgets/video", "widgets/chartjs", "widgets/facebookpage", "widgets/paypal", "widgets/instagram", "widgets/twitter"
...
Vvveb.Components.extend("_base", "widgets/googlemaps", {
  ...
  //location
  t: 'q',
  //map type q = roadmap, w = satellite
  onChange: function onChange(node, property, value) {
...
Vvveb.Components.extend("_base", "widgets/video", {
  ...
  init: function init(node) {
    ...
    $("#right-panel [data-key=url]").hide(); //check if html5
  ...
  onChange: function onChange(node, property, value) {
    this[property.key] = value; //if (property.key == "t")
...
Vvveb.Components.extend("_base", "widgets/facebookpage", {
  ...
  onChange: function onChange(node, input, value, component) {
...
Vvveb.Components.extend("_base", "widgets/chartjs", {
  ...
  properties: [{
    ...
    onChange: function onChange(node, value, input, component) {
