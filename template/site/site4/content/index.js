...
const html = `<section class="w3l-index1" id="about">
      ...
      <div class="container py-md-3">
        ...
        <div class="calltoaction-20-content row">
          <div class="column center-align-self col-lg-6 pr-lg-5">
            ...
            <a class="btn btn-secondary btn-theme2 mt-2 mt-lg-3" href="http://demo2.cssmoban.com/cssthemes6/gfgbdsfsddbs/about.html"> Read More</a>
          </div>
          <div class="column ccont-left col-lg-6 mt-lg-0 mt-5">
            <img src="https://i.loli.net/2020/11/17/zcdDmV2L8rolWpY.jpg" class="img-responsive" alt>
          </div>
        </div>
      </div>
    </div>
